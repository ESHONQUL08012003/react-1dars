import { img1 } from "../../assests/imgs";
import { img2 } from "../../assests/imgs";
import { img3 } from "../../assests/imgs";
import { img4 } from "../../assests/imgs";
import { img5 } from "../../assests/imgs";
import { img6 } from "../../assests/imgs";
import { img7 } from "../../assests/imgs";
import { elips } from "../../assests/imgs";
import { carusel } from "../../assests/imgs";
import { cardImg } from "../../assests/imgs";
        ...
        <section className="hero mb-5">
          <div className="container">
            ...
            <div className="d-flex justify-content-center gap-5 mb-5">
              ...
              <button className="sent-btn-hero">
        ...
        <div>
          <div className="text-center">
            ...
            <div className="d-flex justify-content-center flex-column align-items-center gap-4">
              <button className="search-btn-hero"> Donasi dengan Kami<i class="fas fa-donate"></i></button>

              <span>Atau</span>

              <button className="sent-btn-hero d-flex gap-2 align-items-center mb-5">
